...
keep:
  ...
  - WBP_MainMenu must expose ProjectWorkspaceScreen as its root surface and include ScenarioEditorRootWidget under ProjectScenarioEditPanel; project selection/open/create widgets belong to WBP_StartupMenu.
...
verify:
  ...
  - UmgMcp get_widget_tree after StartupMenu/MainMenu UMG structure edits
  - Blueprint compile/save for StartupMap, WBP_StartupMenu, WBP_MainMenu, WBP_ScenarioEditorRootWidget, and ScenarioEditorMap binding changes
