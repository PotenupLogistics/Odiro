...
keep:
  ...
  - Runtime corridor surfaces are materialized as procedural prism meshes from sampled axis points, lane offset ranges, and lane surface height offsets; keep visual/collision footprint deterministic and aligned with the analytic surface query.
