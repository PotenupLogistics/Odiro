...
keep:
  ...
  - User project setting/profile/scenario/policy, run artifact, project preset, and run default file shapes belong in contracts/specs/user-project-data.md; Bridge IPC method shapes belong in contracts/specs/bridge-ipc.md.
