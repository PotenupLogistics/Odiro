...
UScenarioPlaceableComponent::UScenarioPlaceableComponent()
{
...
void UScenarioPlaceableComponent::SetAuthoringHovered(bool bHovered)
{
...
void UScenarioPlaceableComponent::SetAuthoringSelected(bool bSelected)
{
	bAuthoringSelected = bSelected;
}

void UScenarioPlaceableComponent::ApplyAuthoringHoverVisual()
{
	...
	for (UMeshComponent* meshComponent : meshComponents)
	{
		...
		{
			FScenarioAuthoringMeshCustomDepthState customDepthState;
...
void UScenarioPlaceableComponent::ClearAuthoringHoverVisual()
{
	for (const TPair<TWeakObjectPtr<UMeshComponent>, FScenarioAuthoringMeshCustomDepthState>& cachedCustomDepthState
...
void UScenarioPlaceableComponent::CollectOwnerMeshComponents(TArray<UMeshComponent*>& outMeshComponents) const
{
