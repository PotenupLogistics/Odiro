...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OdiroSim.MeasurementLog.ContractDefaults",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OdiroSim.MeasurementLog.JsonSerialization",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FEpisodeMeasurementLogJsonSerializationTest::RunTest(const FString& Parameters)
{
	...
	RobotActor.ActorCategory = EScenarioActorCategory::DeliveryBot;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OdiroSim.MeasurementLog.Validation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
