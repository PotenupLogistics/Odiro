...
public:
	...
	// ÏßÄÎ©??ÅÏó≠??Í∑∏Î¶¨???âÎ©¥???íÏù¥(cm). ÏΩîÎÑà traceÍ∞Ä ???âÎ©¥???¨ÏòÅ??
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Scenario|Editor|RegionDraw")
	double GroundRegionDrawPlaneZCm = 0.0;

	// ?úÎûòÍ∑∏Ìïú ?¨Í∞Å?ïÏùò Í∞ÄÎ°??∏Î°úÍ∞Ä Î™®Îëê ??Í∞??¥ÏÉÅ?¥Ïñ¥??Ïª§Î∞ã??ÏßßÏ? ?¥Î¶≠?Ä Î¨¥Ïãú).
	...
	// ÏßÄÎ©??ÅÏó≠(walkable/penalty/blocked)??drag-out?ºÎ°ú Í∑∏Î¶¨??Î™®ÎìúÎ°?ÏßÑÏûÖ??
