...
struct ODIROSIM_API FScenarioCityBlockMaterializationResult
{
	...
	// Building collision components available for runtime grid classification.
...
struct ODIROSIM_API FScenarioCityBlockMaterializationOptions
{
	...
	// Preserves BP-authored/static-mesh building blockers or creates fallback proxies while other visual collision stays disabled.
