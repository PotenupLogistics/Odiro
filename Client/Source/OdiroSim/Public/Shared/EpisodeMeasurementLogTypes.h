...
struct ODIROSIM_API FEpisodeMeasurementLogDiagnostic
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogUnits
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogActorInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogActorState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogLidarSnapshot
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogRobotAction
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogRobotTick
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogHeaderRecord
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogTickRecord
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogEventRecord
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FEpisodeMeasurementLogFooterRecord
{
	GENERATED_BODY()
...
struct ODIROSIM_API FEpisodeMeasurementLogJson
{
