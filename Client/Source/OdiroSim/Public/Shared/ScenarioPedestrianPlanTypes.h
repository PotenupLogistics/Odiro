...
struct ODIROSIM_API FScenarioPedestrianPlanPoint
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianPlanReservation
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianBehaviorParams
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianPathShapeParams
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianPlan
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianObstacleFootprint
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianPlanBuildContext
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ODIROSIM_API FScenarioPedestrianPlanBuildResult
{
	GENERATED_BODY()
