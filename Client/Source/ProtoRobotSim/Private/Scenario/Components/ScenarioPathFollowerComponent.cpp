...
UScenarioPathFollowerComponent::UScenarioPathFollowerComponent()
{
...
void UScenarioPathFollowerComponent::SetSplineComponent(USplineComponent* inSplineComponent)
{
...
void UScenarioPathFollowerComponent::SetSplinePath(AScenarioSplinePath* inSplinePath)
{
	if (!inSplinePath)
	{
		PathId.Reset();
...
void UScenarioPathFollowerComponent::StartFollowing()
{
	if (!SplineComponent)
	{
		StopFollowing();
...
void UScenarioPathFollowerComponent::StopFollowing()
{
	SetComponentTickEnabled(false);
}

void UScenarioPathFollowerComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UScenarioPathFollowerComponent::TickComponent(float deltaTime, ELevelTick tickType, FActorComponentTickFunction* thisTickFunction)
{
...
void UScenarioPathFollowerComponent::InitializePathNoise()
{
...
double UScenarioPathFollowerComponent::GetPathNoiseFade(double splineLength) const
{
...
double UScenarioPathFollowerComponent::GetPathNoiseSpeedScale(double splineLength) const
{
...
FVector UScenarioPathFollowerComponent::ApplyPathNoise(double distanceCm, double splineLength, const FVector& baseLocation) const
{
...
void UScenarioPathFollowerComponent::MoveOwnerToCurrentDistance(FHitResult* outSweepHit)
{
	if (outSweepHit)
	{
