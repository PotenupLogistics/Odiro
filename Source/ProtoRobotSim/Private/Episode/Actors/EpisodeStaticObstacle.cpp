...
const TArray<FEpisodeStaticObstaclePropEntry>& AEpisodeStaticObstacle::GetDefaultPropEntries()
{
	...
	{
		MakeStaticObstaclePropEntry(TEXT("obstacle.bin"), TEXT("bin"), TEXT("Bin"), EEpisodeStaticObstaclePropCategory::StreetFurniture, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Bin.SM_Bin"), FVector(45.0, 45.0, 90.0), 75.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.box_01"), TEXT("box"), TEXT("Box 01"), EEpisodeStaticObstaclePropCategory::DeliveryItem, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Box_01.SM_Box_01"), FVector(45.0, 45.0, 45.0), 70.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.box_02"), TEXT("box"), TEXT("Box 02"), EEpisodeStaticObstaclePropCategory::DeliveryItem, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Box_02.SM_Box_02"), FVector(45.0, 45.0, 45.0), 70.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.box_03"), TEXT("box"), TEXT("Box 03"), EEpisodeStaticObstaclePropCategory::DeliveryItem, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Box_03.SM_Box_03"), FVector(45.0, 45.0, 45.0), 70.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.fire_hydrant"), TEXT("fire_hydrant"), TEXT("Fire Hydrant"), EEpisodeStaticObstaclePropCategory::Utility, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_FireHydrant.SM_FireHydrant"), FVector(35.0, 35.0, 80.0), 60.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.mailbox"), TEXT("mailbox"), TEXT("Mailbox"), EEpisodeStaticObstaclePropCategory::StreetFurniture, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Mailbox.SM_Mailbox"), FVector(55.0, 45.0, 90.0), 80.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.manhole_01"), TEXT("manhole"), TEXT("Manhole 01"), EEpisodeStaticObstaclePropCategory::SurfaceObject, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Manhole_01.SM_Manhole_01"), FVector(55.0, 55.0, 5.0), 65.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.manhole_02"), TEXT("manhole"), TEXT("Manhole 02"), EEpisodeStaticObstaclePropCategory::SurfaceObject, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Manhole_02.SM_Manhole_02"), FVector(55.0, 55.0, 5.0), 65.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.manhole_03"), TEXT("manhole"), TEXT("Manhole 03"), EEpisodeStaticObstaclePropCategory::SurfaceObject, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Manhole_03.SM_Manhole_03"), FVector(55.0, 55.0, 5.0), 65.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.manhole_04"), TEXT("manhole"), TEXT("Manhole 04"), EEpisodeStaticObstaclePropCategory::SurfaceObject, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Manhole_04.SM_Manhole_04"), FVector(55.0, 55.0, 5.0), 65.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.road_cone_01"), TEXT("road_cone"), TEXT("Road Cone 01"), EEpisodeStaticObstaclePropCategory::TrafficControl, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_RoadCone_01.SM_RoadCone_01"), FVector(35.0, 35.0, 70.0), 55.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.road_cone_02"), TEXT("road_cone"), TEXT("Road Cone 02"), EEpisodeStaticObstaclePropCategory::TrafficControl, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_RoadCone_02.SM_RoadCone_02"), FVector(35.0, 35.0, 70.0), 55.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.road_barrier_01"), TEXT("road_barrier"), TEXT("Road Barrier 01"), EEpisodeStaticObstaclePropCategory::TrafficControl, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Road_Barrier_01.SM_Road_Barrier_01"), FVector(120.0, 35.0, 60.0), 130.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.road_barrier_02"), TEXT("road_barrier"), TEXT("Road Barrier 02"), EEpisodeStaticObstaclePropCategory::TrafficControl, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Road_Barrier_02.SM_Road_Barrier_02"), FVector(120.0, 35.0, 60.0), 130.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.street_bank"), TEXT("street_bank"), TEXT("Street Bank"), EEpisodeStaticObstaclePropCategory::StreetFurniture, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_StreetBank.SM_StreetBank"), FVector(100.0, 45.0, 60.0), 115.0),
		MakeStaticObstaclePropEntry(TEXT("obstacle.trash_bin"), TEXT("trash_bin"), TEXT("Trash Bin"), EEpisodeStaticObstaclePropCategory::StreetFurniture, TEXT("/Game/Models/StreetObjects/StaticMeshes/SM_Trash_Bin.SM_Trash_Bin"), FVector(45.0, 45.0, 90.0), 75.0)
	};
