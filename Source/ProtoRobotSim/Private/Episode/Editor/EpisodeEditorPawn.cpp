...
void AEpisodeEditorPawn::EnterTopDownView()
{
...
void AEpisodeEditorPawn::EnterPerspectiveView()
{
	if (!bTopDownViewActive) return;
	if (!CameraComponent || !FloatingMovementComponent) return;
...
void AEpisodeEditorPawn::ApplyTopDownPanInput(float forwardValue, float rightValue)
{
	if (!Controller) return;
...
void AEpisodeEditorPawn::ApplyTopDownDragPanInput(float rightValue, float upValue)
{
	if (!bTopDownViewActive) return;
...
void AEpisodeEditorPawn::ApplyTopDownZoomInput(float zoomValue)
{
...
void AEpisodeEditorPawn::ApplyTopDownPanSpeed()
{
	if (!FloatingMovementComponent) return;
