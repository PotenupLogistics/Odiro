...
void UEpisodeCompiler::CompileRobotSpawn(const FJsonObject& actorsObject, FEpisodeCompileResult& result, TSet<FString>& instanceIds)
{
	...
	{
		AddDiagnostic(result, EEpisodeCompileDiagnosticSeverity::Warning,TEXT("missing_robot_goal"),
			TEXT("actors.robot.spawn_only is false, but route.goal_m or goal_m is missing.")
		);
	}
