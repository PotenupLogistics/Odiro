...
namespace
{
	const FEpisodeParamValue* FindPedestrianProperty(
	...
	double GetFloatPropertyOrDefault(
		...
		double defaultValue)
	{
		const FEpisodeParamValue* paramValue = FindPedestrianProperty(compileResult, key);
		return paramValue && paramValue->Type == EEpisodeParamValueType::Float
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FEpisodeCompilerPedestrianBehaviorOptionalTest,
	"ProtoRobotSim.Episode.Compiler.PedestrianBehaviorOptional",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FEpisodeCompilerPedestrianBehaviorOptionalTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FEpisodeCompilerPedestrianBehaviorValuesTest,
	"ProtoRobotSim.Episode.Compiler.PedestrianBehaviorValues",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FEpisodeCompilerPedestrianBehaviorValuesTest::RunTest(const FString& Parameters)
{
	const FString json = TEXT(R"JSON(
{
  "schema": "episode_actor_spawn_mvp",
