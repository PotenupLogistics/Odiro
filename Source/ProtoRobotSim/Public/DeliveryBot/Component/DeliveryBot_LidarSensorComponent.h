...
class PROTOROBOTSIM_API UDeliveryBot_LidarSensorComponent : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	void DrawDebugNearObstacleWarningRange(const FVector& sensorLocationCm) const;
