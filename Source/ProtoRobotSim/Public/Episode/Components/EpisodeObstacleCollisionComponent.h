...
#include "EpisodeObstacleCollisionComponent.generated.h"
...
class PROTOROBOTSIM_API UEpisodeObstacleCollisionComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UEpisodeObstacleCollisionComponent();
