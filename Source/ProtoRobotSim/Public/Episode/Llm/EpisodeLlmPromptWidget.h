...
#include "EpisodeLlmPromptWidget.generated.h"
...
class PROTOROBOTSIM_API UEpisodeLlmPromptWidget : public UUserWidget
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION()
	void HandleGenerationCompleted(const FEpisodeLlmGenerationResult& result);
...
private:
	...
	UEpisodeLlmAuthoringSubsystem* GetLlmAuthoringSubsystem() const;
