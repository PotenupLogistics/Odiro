...
class PROTOROBOTSIM_API AScenarioEditorPawn : public APawn
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Episode|Editor|TopDown", meta = (ClampMin = "100.0"))
	double TopDownCameraHeightCm = 10000.0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Episode|Editor|TopDown", meta = (ClampMin = "100.0"))
	double TopDownOrthoWidthCm = 5000.0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Episode|Editor|TopDown", meta = (ClampMin = "1.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Episode|Editor|TopDown", meta = (ClampMin = "0.001"))
	double TopDownZoomStepRatio = 0.1;

	// drag pan 입력 1 단위당 이동량을 현재 ortho width 대비 비율로 결정함.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Episode|Editor|TopDown", meta = (ClampMin = "0.0"))
