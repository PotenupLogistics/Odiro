...
KEYWORD_RULES: list[tuple[tuple[str, ...], str]] = [
    (("비상", "정지", "충돌"), "비상정지"),
    (("속도", "천천히", "보호구역"), "속도"),
    (("장애물", "정적 장애물", "킥보드", "공유 킥보드", "막힘", "막고", "경로를 막", "경로 차단", "차단", "blockingratio"), "장애물 감지"),
    (("장애물", "정적 장애물", "킥보드", "막힘", "막고", "경로를 막", "경로 차단", "차단", "blockingratio"), "장애물 회피"),
    (("장애물", "정적 장애물", "경로 차단", "blockingratio"), "perception_requirement"),
    (("횡단보도", "신호등", "횡단", "건너"), "횡단보도"),
    (("보도", "좁은 보도", "좁은 길"), "보도"),
    (("관제", "원격", "수동"), "관제장치"),
