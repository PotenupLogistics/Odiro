...
def run_check() -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        ...
        "deliveryBotVariationPolicyExists": all(term in variation_text for term in ["delivery_bot_tuning_for_episode", "short_stop", "early_slowdown", "low_speed"]),
        "testsCoverPolicyComparison": all(term in tests_text for term in ["EpisodeSetup_narrow_sidewalk_fixed_center_block", "DeliveryBotSetup_policy_004_low_speed", "same field sets"]) or "share_identical_field_sets" in tests_text,
