...
def test_field_mapping_doc_contains_required_ue5_fields() -> None:
    text = (ROOT / "docs" / "UE5_WORLD_CONFIG_FIELD_MAPPING.md").read_text(encoding="utf-8")
...
def test_parser_pseudocode_doc_contains_spawn_steps() -> None:
    text = (ROOT / "docs" / "UE5_WORLD_CONFIG_PARSER_PSEUDOCODE.md").read_text(encoding="utf-8")
...
def test_acceptance_checklist_includes_failure_guard() -> None:
    text = (ROOT / "docs" / "UE5_HANDOFF_ACCEPTANCE_CHECKLIST.md").read_text(encoding="utf-8")
